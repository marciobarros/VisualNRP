...
import br.unirio.visualnrp.calc.tunning.RandomSamplingCutSize;
 ...
 * @author Marcio
 */
public class CommandRandomSamplingCut extends Command
{
	 ...
	 */
	public CommandRandomSamplingCut()
	{
		super("TRC", "Random sampling cut size");
	...
	public boolean run() throws Exception
	{
		...
		new RandomSamplingCutSize().execute(instances, budgets, outputFilename);
		return false;
	}
	...
	{
		return new CommandRandomSamplingCut();
	}
}