...
import br.unirio.visualnrp.calc.optimizer.CostRiskOnlyOptimizer;
 ...
 * @author marciobarros
 */
public class CommandOptimizeCostRiskOnly extends Command
{
	 ...
	 */
	public CommandOptimizeCostRiskOnly()
	{
		super("OCO", "Optimization report for the cost risk only problem");
	...
	public boolean run() throws Exception
	{
		...
		new CostRiskOnlyOptimizer().execute(instances, budgets, outputFilename);
		return false;
	}
	...
	{
		return new CommandOptimizeCostRiskOnly();
	}
}