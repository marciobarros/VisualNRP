...
import br.unirio.visualnrp.calc.landscape.CostCapLandscapeReport;
...
/**
 * Class that represents the command that generates the cost cap landscape report
 * 
 * @author Marcio
 */
public class CommandCostCapLandscape extends Command
{
	 ...
	 */
	public CommandCostCapLandscape()
	{
		super("LCCR", "Landscape report for the cost cap problem");
	...
	public boolean run() throws Exception
	{
		...
		new CostCapLandscapeReport().execute(instances, budgets, riskLevels, outputFilename);
		return false;
	}
	...
	{
		return new CommandCostCapLandscape();
	}
}